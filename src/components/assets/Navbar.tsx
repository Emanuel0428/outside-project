...
const Navbar = () => {
  ...
  const mobileMenu = useMemo(() => (
    ...
    >
      ...
      <Link to="/articles" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-400 transition-colors flex items-center gap-2" onClick={() => setIsMobileOpen(false)}>
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-8 items-center">
          ...
          <Link to="/articles" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-400 transition-colors flex items-center gap-2">
            <Book className="h-5 w-5" /> Artículos
          </Link>
          <div className="relative">
            <button onClick={() => setIsAccountOpen(!isAccountOpen)} className="text-white hover:text-purple-400 transition-colors flex items-center gap-2">
        ...
        <button className="md:hidden text-white light:text-black" onClick={() => setIsMobileOpen(!isMobileOpen)} aria-label="Toggle mobile menu">
