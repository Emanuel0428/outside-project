  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-black via-purple-900 to-black text-white overflow-hidden">
      <Helmet>
        ...
        <meta
          name="description"
          content="Explora los mejores artículos sobre vapes: desde qué son los vapes, tipos de vapers, precios y dónde comprarlos, hasta sus consecuencias y los mejores sabores. Descubre vapes desechables, recargables y más en México y el mundo."
        />
        <meta
          name="keywords"
          content="vapes, mejores vapes, vapes desechables, vapes recargables, vaping, vapes en México, precios de vapes, dónde comprar vapes, vapes saludables, consecuencias de los vapes, sabores de vapes, vapes para principiantes"
        />
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1">
                ...
                <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                  Marcas como <strong>Geek Bar</strong>, <strong>Fume Vapes</strong>, y <strong>Elf Bar</strong> son algunas de las <strong>mejores marcas de vapes</strong> disponibles en el mercado. ¿Quieres probar uno? <Link to="/" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">Explora nuestra colección de vapes</Link> y encuentra el perfecto para ti.
                </p>
              </div>
              <motion.img
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 md:p-8 shadow-lg border border-purple-900/50">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1">
                ...
                <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                  ¿<strong>Qué sabores de vapers son los mejores</strong>? En Outside, recomendamos probar los <strong>Geek Bar Pulse</strong> con sabor a <strong>Blue Razz Ice</strong> o los <strong>Fume Vapes</strong> con sabor a <strong>Strawberry Mango</strong>. ¿Listo para encontrar tu sabor favorito? <Link to="/" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">Explora nuestra selección de sabores</Link> y descubre el vape perfecto para ti.
                </p>
              </div>
              <motion.img
                src="https://images.unsplash.com/photo-1600585154102-4a98b7b0c1f3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80"
        ...
        >
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 md:p-8 shadow-lg border border-purple-900/50">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1">
                <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-4">
                  Si te preguntas <strong>cuánto cuestan los vapes</strong>, los precios varían según el tipo y la marca. Por ejemplo, los <strong>vapes desechables</strong> como los <strong>Dummy Vapes</strong> o <strong>Breeze Vapes</strong> pueden costar entre $150 y $300 MXN, mientras que los <strong>vapes recargables</strong> suelen estar entre $500 y $1,500 MXN.
                </p>
                <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                  En <strong>México</strong>, los vapes están prohibidos para su venta directa, pero puedes encontrar <strong>vapes a domicilio</strong> o <strong>vapes por mayoreo</strong> en línea. ¿<strong>Dónde comprar vapes</strong>? Sitios como <strong>Amazon</strong> o mercados especializados ofrecen <strong>vapes al por mayor</strong>. También puedes buscar <strong>vapes cerca de mí</strong> para encontrar opciones locales. En Outside, ofrecemos una amplia selección de <Link to="/" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">vapes a domicilio</Link> para que disfrutes del mejor vaping.
                </p>
              </div>
              <motion.img
                src="https://images.unsplash.com/photo-1600585154216-6e8492d4e5f8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80"
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 md:p-8 shadow-lg border border-purple-900/50">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1">
                ...
                <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                  Si buscas <strong>vapes saludables</strong>, opta por <strong>vapes sin nicotina</strong> o <strong>vapes 0 nicotina</strong>. Además, en <strong>México</strong>, los vapes son ilegales desde 2022, lo que ha generado debates sobre <strong>por qué son ilegales los vapes en México</strong>. Sin embargo, muchos usuarios siguen prefiriendo el <strong>vaping</strong> como alternativa al tabaco. ¿Quieres una opción más segura? <Link to="/" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">Explora nuestros vapes sin nicotina</Link>.
                </p>
              </div>
              <motion.img
                src="https://images.unsplash.com/photo-1600585154228-9e4b61e9e01e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80"
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 md:p-8 shadow-lg border border-purple-900/50">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1">
                ...
                <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                  Si prefieres algo más pequeño, los <strong>vapes 600 puffs</strong> son una buena opción. ¿Te interesa saber <strong>cuánto duran los vapes recargables</strong>? Esto dependerá de la frecuencia de uso y el mantenimiento. En Outside, ofrecemos <Link to="/" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">vapes de alta duración</Link> para que disfrutes más tiempo.
                </p>
              </div>
              <motion.img
                src="https://images.unsplash.com/photo-1600585154102-4a98b7b0c1f3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80"
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 md:p-8 shadow-lg border border-purple-900/50">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1">
                ...
                <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                  Considera tus preferencias: ¿quieres un <strong>vape con pantalla</strong> para mayor control, o prefieres algo sencillo? ¿Buscas <strong>vapes de mota</strong> o <strong>vapes sin nicotina</strong>? En Outside, te ayudamos a encontrar el vape perfecto para tu estilo. <Link to="/" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">Descubre nuestra selección ahora</Link> y comienza tu experiencia de vaping.
                </p>
              </div>
              <motion.img
                src="https://images.unsplash.com/photo-1600585154526-990d71bee1e3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80"
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 md:p-8 shadow-lg border border-purple-900/50">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
                  Los vapes suelen contener nicotina, propilenglicol, glicerina vegetal y saborizantes. Si buscas una opción más segura, prueba los <Link to="/" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">vapes sin nicotina</Link> disponibles en nuestra tienda.
                </p>
              </div>
            </div>
            <div className="mt-4 flex justify-end">
